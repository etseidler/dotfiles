...
* Roll back to pre-0.25.x codebase (#504, [#505](https://github.com/weaveworks/vscode-gitops-tools/issues/505))
...
* Pin extension telemetry @ 0.6.x until we can resolve [#477](https://github.com/weaveworks/vscode-gitops-tools/issues/477)
...
* Major enhancement: fork and exec/kubectl CLI is mostly removed from the main process flow.
  ...
  * Closes [#422](https://github.com/weaveworks/vscode-gitops-tools/issues/422) - Fork and exec is dangerous and slow
...
* Merge pull request [#418](https://github.com/weaveworks/vscode-gitops-tools/issues/418) from weaveworks/release-pr

# v0.23.0

* Merge pull request [#417](https://github.com/weaveworks/vscode-gitops-tools/issues/417) from kingdonb/fix-readme-svg-issue
  * SVGs are restricted in README
* Merge pull request [#416](https://github.com/weaveworks/vscode-gitops-tools/issues/416) from kingdonb/node-19
  * try node 19
* Merge pull request [#415](https://github.com/weaveworks/vscode-gitops-tools/issues/415) from weaveworks/edge
* Merge pull request [#414](https://github.com/weaveworks/vscode-gitops-tools/issues/414) from kingdonb/fix-flux-cli
...
* Merge pull request [#397](https://github.com/weaveworks/vscode-gitops-tools/issues/397) from weaveworks/release-pr
...
* Fix [#302](https://github.com/weaveworks/vscode-gitops-tools/issues/302), parsing flux CLI output correctly from changes in Flux 0.31.2 (#303)
...
* [#289](https://github.com/weaveworks/vscode-gitops-tools/issues/289) from juozasg/remove-logo-from-readme
* [#288](https://github.com/weaveworks/vscode-gitops-tools/issues/288) from kingdonb/update-changelog

# v0.19.5 - [2022-06-08]

* [#286](https://github.com/weaveworks/vscode-gitops-tools/issues/286) from kingdonb/releases-in-pr

# v0.19.4 - [2022-06-08]

* [#285](https://github.com/weaveworks/vscode-gitops-tools/issues/285) from kingdonb/fixup-release-metadata

# v0.19.3 - [2022-06-08]

* [#283](https://github.com/weaveworks/vscode-gitops-tools/issues/283) from kingdonb/gh-actions-auto-pr
* Set the `GITHUB_TOKEN` environment variable
* [#282](https://github.com/weaveworks/vscode-gitops-tools/issues/282) from kingdonb/no-exceptions-robot
* No exceptions, robot
* [#281](https://github.com/weaveworks/vscode-gitops-tools/issues/281) from kingdonb/upgrade-vscode-engine
* pre-release versions are not supported until a certain vscode engine version
* [#280](https://github.com/weaveworks/vscode-gitops-tools/issues/280) from kingdonb/test-edge-script
* Add edge version supporting release machinery
* [#279](https://github.com/weaveworks/vscode-gitops-tools/issues/279) from kingdonb/test-requirements
* Run test with requirements
* [#278](https://github.com/weaveworks/vscode-gitops-tools/issues/278) from kingdonb/release-marketplace
...
* [#277](https://github.com/weaveworks/vscode-gitops-tools/issues/277) from juozasg/fix-229-loading-dotdotdot
* query workload children in targetNamespace
* [#275](https://github.com/weaveworks/vscode-gitops-tools/issues/275) from kingdonb/prereleases-automatically-marked
* pin-github-actions
* `alpha.6` - automatically mark prereleases
* [#274](https://github.com/weaveworks/vscode-gitops-tools/issues/274) from kingdonb/fix-flux-v1-bug
* Fix bug querying too broadly HelmReleases
* [#272](https://github.com/weaveworks/vscode-gitops-tools/issues/272) from weaveworks/remove-double-colon
* Fix "GitOps Running: :"
* [#270](https://github.com/weaveworks/vscode-gitops-tools/issues/270) from weaveworks/parallelize-source-data
* parallel awaits for Sources in sourceDataProvider
* README.md:clsuter→cluster (#268)
* [#263](https://github.com/weaveworks/vscode-gitops-tools/issues/263) from weaveworks/integration-tests
* Increase slightly Timeout for this test
* use kind 0.12.0
* [#262](https://github.com/weaveworks/vscode-gitops-tools/issues/262) from weaveworks/integration-tests

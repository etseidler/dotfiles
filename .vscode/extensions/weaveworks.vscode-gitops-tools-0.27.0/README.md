...
![VSCode GitOps Tools](https://github.com/weaveworks/vscode-gitops-tools/raw/HEAD/docs/images/vscode-gitops-tools.png)
...
![VSCode GitOps Tools Context Menu](https://github.com/weaveworks/vscode-gitops-tools/raw/HEAD/docs/images/vscode-configure-gitops.png)

_(Configure GitOps view is used to create sources and workloads)_

## Context Menus

![VSCode GitOps Tools Context Menu](https://github.com/weaveworks/vscode-gitops-tools/raw/HEAD/docs/images/vscode-context-menu.png)
...
![VSCode GitOps Commands](https://github.com/weaveworks/vscode-gitops-tools/raw/HEAD/docs/images/vscode-gitops-commands.png)
...
![VSCode GitOps Tools](https://github.com/weaveworks/vscode-gitops-tools/raw/HEAD/docs/images/vscode-install-flux.png)
...
![Enable WGE Features](https://github.com/weaveworks/vscode-gitops-tools/raw/HEAD/docs/images/config-enable-wge.png)

![Weave GitOps Treeview](https://github.com/weaveworks/vscode-gitops-tools/raw/HEAD/docs/images/weave-gitops-treeview.png)

![Create GitOps Template](https://github.com/weaveworks/vscode-gitops-tools/raw/HEAD/docs/images/vscode-templates-view.png)
